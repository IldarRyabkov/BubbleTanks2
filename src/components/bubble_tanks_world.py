...
def generate_test():
    ...
    enemies["Scarab"] = 1
    enemies["Turret"] = 1
    enemies["StickyTurtle"] = 1
    enemies["Turtle"] = 1
    enemies["EnemySpawnerLarge"] = 1
    enemies["SmallCarrier"] = 1
    enemies["BomberShooter"] = 1
    enemies["BenLaden"] = 1
    enemies["Mortar"] = 1
    enemies["EnemySpawner"] = 1
    enemies["SeekerSpawner"] = 1
    enemies["Spider"] = 1
    enemies["Beetle"] = 1
    enemies["Spreader"] = 1
    enemies["MachineGunner"] = 1
    enemies["Propeller"] = 1
    enemies["SmallPropeller"] = 1
    enemies["BigBaby"] = 1
    enemies["StingerLarge"] = 1
    enemies["Stinger"] = 1
    enemies["InfusoriaSpawner"] = 1
    enemies["BubbleContainer"] = 1
    enemies["Sucker"] = 1
    enemies["Snail"] = 1
    enemies["FatSpreader"] = 1
    enemies["SmallVampire"] = 1
    enemies["LargeVampire"] = 1
    enemies["BubbleBomber"] = 1
    enemies["LongSpreader"] = 1
    enemies["LargeMachineGunner"] = 1
    enemies["Destroyer"] = 1
    enemies["Twins"] = 1
    enemies["LongMachineGunner"] = 1
    enemies["Predator_1"] = 1
    enemies["Predator_2"] = 1
    enemies["MixedEnemy"] = 1
    enemies["Confusion"] = 1
    return enemies
