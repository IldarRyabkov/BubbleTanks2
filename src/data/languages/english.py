# StartMenu text data
START_MENU_CAPTION = 'Underwater battles'
PLAY_BUTTON = 'PLAY'
...
OPTIONSWINDOW_BUTTONS_TEXTS = ['ON.', 'OFF.', 'TO MENU']
...
VICTORYMENU_CAPTION = 'CONGRATULATIONS!'
VICTORYMENU_TEXT = 'You passed the game!'
