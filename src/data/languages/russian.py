# StartMenu text data
START_MENU_CAPTION = 'Подводные битвы'
PLAY_BUTTON = 'ИГРАТЬ'
...
OPTIONSWINDOW_BUTTONS_TEXTS = ['ВКЛ.', 'ВЫКЛ.', 'В МЕНЮ']
...
VICTORYMENU_CAPTION = 'ПОЗДРАВЛЯЕМ!'
VICTORYMENU_TEXT = 'Ты прошел игру!'
