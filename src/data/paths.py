...
ROOM_AIM = os.path.abspath(os.path.join(ROOT_DIR, "images/room_aim.png"))
BOSS_AIM = os.path.abspath(os.path.join(ROOT_DIR, "images/boss_aim.png"))
...
THUNDER = os.path.abspath(os.path.join(ROOT_DIR, 'sounds/thunder.wav'))
